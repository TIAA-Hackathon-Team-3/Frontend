      ...
      <CardContent sx={{ padding: theme => `${theme.spacing(3.25, 5, 4.5)} !important` }}>
        ...
        <Box>
          ...
          <Typography variant='body2' sx={{ marginBottom: 3, textAlign: 'justify', color: 'inherit' }}>
            Technology has greatly transformed and improved our lives in many ways. It has revolutionized how we
            communicate, work, learn, entertain, and even how we think. With the help of technology, we can access
            information and connect with people from all over the world instantly. It has also enabled us to solve
            complex problems, automate processes, and create new opportunities for growth and development. However, it
            is important to use technology responsibly and ethically, and to ensure that its benefits are accessible to
            everyone.
          </Typography>
        </Box>
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Box sx={{ position: 'flex', left: '400px', bottom: '0px' }}>
              <FlagButton />
            </Box>
